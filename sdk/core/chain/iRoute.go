...
import (
	...
	"github.com/jxo-me/netx/sdk/core/common/net/dialer"
	"github.com/jxo-me/netx/sdk/core/common/net/udp"
	"github.com/jxo-me/netx/sdk/core/logger"
)

var (
	ErrEmptyRoute = errors.New("empty eRoute")
)

var (
	DefaultRoute IRoute = &eRoute{}
)
...
// eRoute is a IRoute without nodes.
type eRoute struct{}

func (*eRoute) Dial(ctx context.Context, network, address string, opts ...DialOption) (net.Conn, error) {
...
func (*eRoute) Bind(ctx context.Context, network, address string, opts ...BindOption) (net.Listener, error) {
