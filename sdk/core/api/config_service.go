...
func createService(ctx *gin.Context) {
	...
	if sdk.Runtime.ServiceRegistry().IsRegistered(req.Data.Name) {
	...
	if err := sdk.Runtime.ServiceRegistry().Register(req.Data.Name, svc); err != nil {
		svc.Close()
		writeError(ctx, ErrDup)
		return
	}
...
func updateService(ctx *gin.Context) {
	...
	old := sdk.Runtime.ServiceRegistry().Get(req.Service)
	if old == nil {
	...
	sdk.Runtime.ServiceRegistry().Unregister(req.Service)

	if err := sdk.Runtime.ServiceRegistry().Register(req.Service, svc); err != nil {
		svc.Close()
		writeError(ctx, ErrDup)
		return
	}
...
func deleteService(ctx *gin.Context) {
	...
	svc := sdk.Runtime.ServiceRegistry().Get(req.Service)
	if svc == nil {
		writeError(ctx, ErrNotFound)
		return
	}
