...
func NewLogger(opts ...LoggerOption) ILogger {
...
func (l *logrusLogger) WithFields(fields map[string]any) ILogger {
	return &logrusLogger{
...
func (l *logrusLogger) IsLevelEnabled(level LogLevel) bool {
