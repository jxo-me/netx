...
func RedisSetRecorder(addr string, opts ...RedisRecorderOption) IRecorder {
...
func RedisListRecorder(addr string, opts ...RedisRecorderOption) IRecorder {
	var options redisRecorderOptions
	for _, opt := range opts {
		opt(&options)
	}
...
func RedisSortedSetRecorder(addr string, opts ...RedisRecorderOption) IRecorder {
	var options redisRecorderOptions
	for _, opt := range opts {
		opt(&options)
	}
