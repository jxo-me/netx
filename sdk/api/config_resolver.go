...
func createResolver(ctx *gin.Context) {
	...
	if err := sdk.Runtime.ResolverRegistry().Register(req.Data.Name, v); err != nil {
...
func updateResolver(ctx *gin.Context) {
	...
	if !sdk.Runtime.ResolverRegistry().IsRegistered(req.Resolver) {
	...
	sdk.Runtime.ResolverRegistry().Unregister(req.Resolver)

	if err := sdk.Runtime.ResolverRegistry().Register(req.Resolver, v); err != nil {
		writeError(ctx, ErrDup)
		return
	}
