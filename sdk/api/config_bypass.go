...
func createBypass(ctx *gin.Context) {
	...
	v := sdk.Runtime.ParseBypass(&req.Data)

	if err := sdk.Runtime.BypassRegistry().Register(req.Data.Name, v); err != nil {
...
func updateBypass(ctx *gin.Context) {
	...
	if !sdk.Runtime.BypassRegistry().IsRegistered(req.Bypass) {
	...
	sdk.Runtime.BypassRegistry().Unregister(req.Bypass)

	if err := sdk.Runtime.BypassRegistry().Register(req.Bypass, v); err != nil {
		writeError(ctx, ErrDup)
		return
	}
