...
func (p *grpcPlugin) In(ctx context.Context, key string, opts ...limiter.Option) traffic.ILimiter {
	if p.client == nil {
		return nil
	}
...
func (p *grpcPlugin) Out(ctx context.Context, key string, opts ...limiter.Option) traffic.ILimiter {
	if p.client == nil {
		return nil
	}
