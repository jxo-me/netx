...
func WrapConn(c net.Conn, tlimiter traffic.ITrafficLimiter, key string, opts ...limiter.Option) net.Conn {
	if tlimiter == nil {
		return c
	}
...
func (c *limitConn) Metadata() metadata.IMetaData {
...
func WrapPacketConn(pc net.PacketConn, lim traffic.ITrafficLimiter, key string, opts ...limiter.Option) net.PacketConn {
	if lim == nil {
		return pc
	}
	return &packetConn{
...
func WrapUDPConn(pc net.PacketConn, limiter traffic.ITrafficLimiter, key string, opts ...limiter.Option) udp.Conn {
	return &udpConn{
		PacketConn: pc,
		limiter:    limiter,
		opts:       opts,
