...
func (r *Router) dial(ctx context.Context, network, address string, log logger.ILogger) (conn net.Conn, err error) {
...
func routePath(route chain.IRoute) (path []*chain.Node) {
	if route == nil {
		return
	}
