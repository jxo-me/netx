...
import (
	...
	"github.com/jxo-me/netx/x/internal/net/dialer"
...
var (
	DefaultRoute chain.IRoute = &defaultRoute{}
)
...
func (r *chainRoute) connect(ctx context.Context, logger logger.ILogger) (conn net.Conn, err error) {
	network := "ip"
	node := r.nodes[0]
